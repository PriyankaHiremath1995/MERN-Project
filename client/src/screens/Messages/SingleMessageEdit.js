...
import { deleteMessageAction, updateMessageAction } from "../../actions/messageActions";
import ErrorMessage from "../../components/ErrorMessage";
import Loading from "../../components/Loading";
import ReactMarkdown from "react-markdown";
import { useNavigate, useParams } from "react-router-dom";

function SingleMessageEdit() {
...
const {id} = useParams();
  ...
  const updateHandler = (e) => {
    e.preventDefault();
    dispatch(updateMessageAction(id, title, content));
...
export default SingleMessageEdit;